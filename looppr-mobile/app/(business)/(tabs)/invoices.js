          ...
          {(invoices ?? []).map((inv, i) => (
            ...
            >
              <View className="flex-1 min-w-0">
                <Text className="font-body-bold text-[13.5px] text-ink">{inv.label} · {formatCurrency(inv.amount)}</Text>
                <Text className="font-body text-[11.5px] text-muted">{inv.orders} orders · net-30 terms</Text>
              </View>
